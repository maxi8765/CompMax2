...
function initializeApp() {
    ...
    // Format the default salary value with commas
    if (Elements['max-salary'] && !AppState.isEmployeeView) {
        Elements['max-salary'].value = parseInt(Elements['max-salary'].value).toLocaleString('en-US');
    }
}
